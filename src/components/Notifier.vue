<template>
  <v-alert dense v-if="notice.show" :type="alertType" :icon="notice.icon ? '' : undefined" border
    :title="notice.title || ''" :color="notice.color" prominent closable @click:close="hide" style="
      position: fixed;
      top: 80px;
      left: 50%;
