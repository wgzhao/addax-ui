      ...
      <v-card class="mb-6" elevation="2">
        ...
        <v-card-text class="pa-6">
          <v-row>
            ...
            <v-col cols="12" md="6">
              <v-text-field
                v-model="settings.HIVE_CLI"
                label="HIVE 命令行"
                placeholder="hive"
                prepend-inner-icon="mdi-console"
                :rules="[rules.required]"
                hint="Hive命令行工具的路径或命令"
                persistent-hint
              />
            </v-col>
          </v-row>
      ...
      <v-card class="mb-6" elevation="2">
        ...
        <v-card-text class="pa-6">
          <v-row>
            <v-col cols="12" md="8">
              <v-text-field
                ...
                label="JDBC连接地址"
                placeholder="jdbc:hive2://188.166.1.96:10000"
                prepend-inner-icon="mdi-link"
                :rules="[rules.required, rules.jdbcUrl]"
                hint="HiveServer2的JDBC连接地址"
                persistent-hint
              />
            </v-col>
            <v-col cols="12" md="4">
          ...
          <v-row>
            <v-col cols="12" md="4">
              <v-text-field
                v-model="hiveServer2Config.user"
                label="用户名"
                placeholder="hive"
                prepend-inner-icon="mdi-account"
                :rules="[rules.required]"
                hint="连接HiveServer2的用户名"
                persistent-hint
              />
            </v-col>
            <v-col cols="12" md="4">
          ...
          <v-row>
            ...
            <v-col cols="12" md="6">
              <v-text-field
                ...
                type="number"
                placeholder="100"
                prepend-inner-icon="mdi-queue-first-in-last-out"
                :rules="[rules.required, rules.positiveNumber]"
                hint="采集任务队列的最大长度"
                persistent-hint
              />
