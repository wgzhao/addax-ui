                                ...
                                <v-dialog v-model="dialog" max-width="500px">
                                    ...
                                    <v-card>
                                        ...
                                        <v-card-actions>
                                            ...
                                            <v-btn color="blue-darken-1" variant="text" @click="saveDictionary">
                                                Save
                                            </v-btn>
                                        </v-card-actions>
                                    </v-card>
...
const getDictionary = (code) => {
    ...
    DictService.listDictItems(code).then(res => { dictionaries.value = res.data });
}
...
const saveDictionary = () => {
    ...
    // save
    DictService.createOrUpdateDictItem(editedItem.value).then(res => { console.log(res.data); return res.data; });
    close()
}
onMounted(() => {
    DictService.listDicts().then(res => { dicts.value = res.data; return res.data; });
})
