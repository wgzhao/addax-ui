...
.gradient-overlay {
  ...
  width: 100%;
  height: 100%;
  background: radial-gradient(circle at center, rgba(255,255,255,0.05) 0%, rgba(0,0,0,0.9) 70%);
}
...
.login-sheet {
  background: rgba(30, 30, 95, 0.2); /* 调整为更深的半透明底色 */
...
.login-card {
  background: linear-gradient(145deg, #2a2a72 0%, #1e1e5f 100%); /* 深色渐变 */
...
.login-btn {
  ...
  font-weight: 600;
  letter-spacing: 1.5px;
  background: linear-gradient(90deg, #00bcd4 0%, #4dd0e1 100%); /* 青色渐变 */
  color: #ffffff;
